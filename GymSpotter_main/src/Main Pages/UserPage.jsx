...
function UserPage() {
    ...
    useEffect(() => {
        console.log("UserPage frissítése, userName:", userName); // debug
    }, [userName]); // Ha változik rendereljük újkra

    
    console.log("UserPage context:", { isLoggedIn, userName }); // debug
    ...
    return (
        ...
        {isLoggedIn ? (
          <h1 className={`${styles.cim}`}>🎉Üdvözöllek a GymSpotter főoldalán, kedves <span className="text-danger">{userName}</span>!🎉</h1>
        ) : (
