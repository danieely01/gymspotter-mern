    ...
    <div className={`${styles.Komponens}`}>
        ...
        <div className={`container justify-content-center align-items-center p-3 min-vh-100 ${styles.content}`}>
            <div className={`mt-5 ml-5`}>
                <h1>Üdvözlünk a szolgáltatói oldalon!</h1>
                <p>Ha bármivel kapcsolatban probléma merülne fel kérjük vegye fel velünk a kapcsolatot!</p>
                <img src="./public/dumbbell.png" alt="Kézi súlyzó png" />
            </div>                    
        </div>
    </div>    
  )
